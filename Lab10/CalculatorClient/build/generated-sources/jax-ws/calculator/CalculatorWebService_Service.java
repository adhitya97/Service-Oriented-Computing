 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://Calculator/", wsdlLocation = "http://localhost:8080/CalculatorService/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://Calculator/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorService/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://Calculator/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Calculator/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
